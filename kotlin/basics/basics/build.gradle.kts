/*
 * This is a modified version of the default build.gradle.kts file generated by
 * the Gradle 'init' task.
 */
...
dependencies {
    ...
    // So standard practice is to comment out the default Guava
    // dependency and add the latest version explicitly, as shown
    // below.
    ...
    // For kotlin you need the kotlin-test-junit5 dependency and
    // the junit-jupiter-engine dependency and the junit-platform-launcher
...
application {
    ...
    mainClass = "sv.basics.LanguageKt"
}
