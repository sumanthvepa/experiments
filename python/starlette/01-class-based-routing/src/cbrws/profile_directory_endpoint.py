...
class ProfileDirectoryEndpoint(HTTPEndpoint):
  """
  ...
  async def load_json(filename: str, context: dict[str, str]) -> dict[str, Any]:
    ...
    """
    content = await ProfileDirectoryEndpoint.load_file(filename, context)
  ...
  def response_media_type(cls) -> str:
    """
      Generate the media type for the profile directory response.
  ...
  def context(cls, request: Request) -> dict[str, str]:
    """
      Generate the template context for the profile directory.
  ...
  def link_header(cls, request: Request) -> str:
    """
      Generate the Link header value for profile directory responses.
      :param request: The HTTP request
  ...
  def headers(cls, request: Request) -> dict[str, str]:
    """
      Generate common headers for profile directory responses.
      :param request: The HTTP request
  ...
  async def html_response(self, request: Request) -> HTMLResponse:
    """
      Generate an HTML response for the profile directory endpoint.
      :param request: The HTTP request
  ...
  async def json_response(self, request: Request) -> JSONResponse:
    """
      Generate a HAL JSON response for the profile directory endpoint.
      :param request: The HTTP request
  ...
  async def get(self, request: Request) -> Response:
    """
      Handle GET requests to the profile directory endpoint.
      :param request: The HTTP request
      :return: A Response with either HTML or HAL JSON content
    """
  ...
  async def head(self, request: Request) -> Response:
    """
      Handle HEAD requests to the profile directory endpoint.
      :param request: The HTTP request
  ...
  async def options(self, request: Request) -> Response:
    """
      Handle OPTIONS requests for the profile directory endpoint.
      :param request: The HTTP request
  ...
  async def method_not_allowed(self, request: Request) -> JSONResponse:
    """
      Handle methods that are not allowed for the profile directory endpoint.
      :param request: The HTTP request
      :return: A JSONResponse with problem details
    """
    cls = type(self)
