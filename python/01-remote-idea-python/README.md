...
### Phase 2: Step 4: Setup the stubs file for parameterized
The parameterized library does not come with type annotations
This causes mypy to complain when doing static analysis of test suite
code. To overcome this problem, I've created a type annotations file
in stubs/parameterized/__init__.py. This defines the type signatures
of the parts of the library that I use most commonly.
Read the notes in /python/testing/test/test_sample.py for how
to use stubgen to create an inital stub file.
